...
* **Objective** - To create a fullstack application whose frontend is statically generated by Jekyll, rendered by Thymeleaf, and has services mediated by Spring Boot
* **Purpose** - To gain familiarity with fullstack application development using Jekyll, Thymeleaf, and Springboot
